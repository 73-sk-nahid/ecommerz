...
import 'package:ecommerz/features/home/data/models/slider_model.dart';
import 'package:ecommerz/features/home/data/models/slider_pagination_model.dart';
...
class SliderListController extends GetxController {
  ...
  List<SliderModel> get sliderList => _sliderPaginationModel?.data?.results ?? [];
  ...
  Future<bool> getSliders() async {
    ...
    await Get.find<NetworkCaller>().getRequest(Urls.slidesURL);
